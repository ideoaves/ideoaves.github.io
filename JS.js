...
const tsubure = window.location.pathname === '/' || window.location.pathname.endsWith('/index.html') ? 1.0 : 0.4;
...
function setup() {
  ...
  let divHeight = divWidth * ((202.43 / 1201.37) * tsubure);
